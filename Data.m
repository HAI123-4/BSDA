...
x0 = [10.5, 0.04, S_meas_smooth(idx_80), 0.01];
lb = [10.3, 0.001, 1e-6, 1e-5];
ub = [10.7, 0.99, 1e3, 1];
...
disp('Parameter | Optimized Value | Standard Deviation | Coefficient of Variation');
fprintf('ω    | %.4f | %.4f | %.4f\n', x_opt(1), SD(1), COV(1));
fprintf('ζ    | %.4f | %.4f | %.4f\n', x_opt(2), SD(2), COV(2));
fprintf('S_f0 | %.4f | %.4f | %.4f\n', x_opt(3), SD(3), COV(3));
fprintf('σ_e^2| %.4f | %.4f | %.4f\n', x_opt(4), SD(4), COV(4));
